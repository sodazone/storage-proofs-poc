// from https://github.com/rustwasm/wasm-pack/issues/1334
...
await rename(`./dist/pkg/${name}.d.ts`, `./dist/${name}.d.ts`);
await rename(`./dist/pkg/${name}.js`, `./dist/${name}.js`);
await rename(`./dist/pkg/${name}_bg.wasm`, `./dist/${name}_bg.wasm`);
